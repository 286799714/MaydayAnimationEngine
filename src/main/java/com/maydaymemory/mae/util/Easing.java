...
public interface Easing {
    ...
    public static final Easing SINE_IN = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return -c * (float) org.joml.Math.cos(t/d * (Math.PI/2)) + c + b;
        }
    };
    ...
    public static final Easing SINE_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return c * (float) org.joml.Math.sin(t/d * (Math.PI/2)) + b;
        }
    };
    ...
    public static final Easing SINE_IN_OUT = new Easing() {
        public float ease(float t, float b, float c, float d) {
            return -c/2 * ((float)org.joml.Math.cos(Math.PI*t/d) - 1) + b;
        }
    };
    ...
    public static class ElasticOut extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            return a*(float)Math.pow(2,-10*t) * (float)org.joml.Math.sin( (t*d-s)*(2*Math.PI)/p ) + c + b;
        }
    }
    ...
    public static class ElasticInOut extends Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t < 1) return -.5f*(a*(float)Math.pow(2,10*(t-=1)) * (float)org.joml.Math.sin( (t*d-s)*(2*Math.PI)/p )) + b;
            return a*(float)Math.pow(2,-10*(t-=1)) * (float)org.joml.Math.sin( (t*d-s)*(2*Math.PI)/p )*.5f + c + b;
        }
    }
