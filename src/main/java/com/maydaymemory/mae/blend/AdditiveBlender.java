 ...
 * }</pre>
 * <p>
 * Compared to {@link AdditionalBlender}, which uses quaternion multiplication for rotation blending
 * and is sensitive to blending order, this approach prioritizes simplicity and symmetry.
 * </p>
 *
 * @see AdditionalBlender for a non-commutative blending mode using quaternion multiplication.
 */
